...
public:
    ...
    std::vector<std::vector<int>> encode_character_level(const std::vector<std::string>& texts) const;
    std::vector<std::vector<int>> encode_bpe(const std::vector<std::string>& texts) const;
